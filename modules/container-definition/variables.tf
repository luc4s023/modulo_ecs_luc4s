...
variable "create_cloudwatch_log_group" {
  description = "Criar CloudWatch Log Group para o container"
  type        = bool
  default     = true
}
...
variable "log_group_name" {
  description = "Nome customizado do log group. Se não informado, usa /ecs/{var.name}"
  type        = string
  default     = null
}

variable "tags" {
  description = "Tags para aplicar ao log group"
  type        = map(string)
  default     = {}
}
